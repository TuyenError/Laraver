...
                  <h5 class="color-black">@if(Session::has('cart')){{number_format($cart->totalPrice)}}@else 0 @endif đồng
                  </h5>
                </div>
                <div class="clearfix"></div>
              </div>
...
                    Thực hiện thanh toán trực tiếp vào tài khoản ngân hàng của chúng tôi. Vui lòng sử dụng mã đơn hàng của bạn làm thông tin chuyển khoản. Đơn hàng của bạn sẽ không được gửi đi cho đến khi số tiền đã được thanh toán và chuyển vào tài khoản của chúng tôi.
                  </div>
                </li>

                <li class="payment_method_vnpay">
                  <input id="payment_method_vnpay" type="radio" class="input-radio" name="payment_method" value="vnpay"
                    data-order_button_text="Tiếp tục thanh toán qua VnPay">
                  <label for="payment_method_vnpay">VnPay</label>
                  <div class="payment_box payment_method_vnpay" style="display: none;">
                    Thanh toán qua VnPay; bạn có thể sử dụng thẻ tín dụng của mình nếu bạn không có tài khoản VnPay.
                  </div>
                </li>
              </ul>
            </div>
